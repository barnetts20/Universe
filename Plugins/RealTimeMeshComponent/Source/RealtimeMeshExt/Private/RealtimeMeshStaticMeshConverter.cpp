	...
	const FStreamSetStaticMeshConversionOptions& Options)
{
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyFromStaticMesh failed: InStaticMesh is null"));
		return false;
	}
	...
	FStreamSetStaticMeshConversionOptions Options, ERealtimeMeshOutcomePins& Outcome)
{
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyFromStaticMesh failed: FromStaticMeshAsset is null"));
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyFromStaticMesh failed: ToStreamSet is null"));
		Outcome = ERealtimeMeshOutcomePins::Failure;
		return ToStreamSet;
	}
	...
	FStreamSetStaticMeshConversionOptions Options, ERealtimeMeshOutcomePins& Outcome)
{
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyToStaticMesh failed: FromStreamSet is null"));
		Outcome = ERealtimeMeshOutcomePins::Failure;
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyToStaticMesh failed: ToStaticMeshAsset is null"));
		Outcome = ERealtimeMeshOutcomePins::Failure;
		return ToStaticMeshAsset;
	}
	...
	FRealtimeMeshStaticMeshConversionOptions Options, ERealtimeMeshOutcomePins& Outcome)
{
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyFromStaticMesh failed: ToRealtimeMesh is null"));
		Outcome = ERealtimeMeshOutcomePins::Failure;
		return ToRealtimeMesh;
	}
	...
	for (int32 LODIndex = MinLOD; LODIndex <= MaxLOD; LODIndex++)
	{
		...
		{
			UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyFromStaticMesh failed: Failed to copy LOD %d"), LODIndex);
			ToRealtimeMesh->Reset(false);
			return nullptr;
		}
	...
	if (Options.bWantsNanite && IRealtimeMeshNaniteSceneProxyManager::IsNaniteSupportAvailable())
	{
                                                                            ...
                                                                            const FStreamSetStaticMeshConversionOptions& Options)
{
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyStreamSetToStaticMesh failed: Requested LOD Type is not available"));
		return false;
	}*/
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyFromStaticMesh failed: StaticMesh bAllowCPUAccess must be set to true to read mesh data at Runtime"));
		return false;
	}
#endif
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyFromStaticMesh failed: Request LOD is not available"));
		return false;
	}
	...
	const FStreamSetStaticMeshConversionOptions& Options)
{
	...
	{
		UE_LOG(RealtimeMeshLog, Warning, TEXT("RealtimeMeshWarning: CopyStreamSetToStaticMesh failed: Request LOD is not available"));
		return false;
	}
